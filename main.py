# user query 
# retrivers : similarity stratigies = similarity serach|mmr|multiquery
# similar chunks + query
# prompt generate 
# feed prompt to LLM to gen answer🎉
...
load_dotenv()
embedding_model = MistralAIEmbeddings(model = "codestral-embed")
vectorstore = Chroma(
